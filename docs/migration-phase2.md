...
- [ ] CI/Lint/Test pipeline zorunlu hale getirilecek (EASY-030/EASY-031)

## 9) Next Actions

1. EASY-028: domain test kapsam genisletme  
2. EASY-029: kritik UI akislarinda `shinytest2` otomasyonu  
3. EASY-030: lint ve statik kontrol adimi  
4. EASY-031: PR zorunlu CI hattinin devreye alinmasi
