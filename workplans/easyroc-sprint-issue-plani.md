...
| [x] | EASY-029 | `shinytest2` kritik akış testleri | P0 | 8 | EASY-020..023 | Kritik UI akışları otomasyon altında |
| [x] | EASY-030 | Lint ve statik kontrol ekle | P1 | 3 | EASY-027 | CI’da lint adımı aktif |
| [x] | EASY-031 | GitHub Actions CI pipeline | P0 | 5 | EASY-028..030 | PR’da test/lint zorunlu |
| [x] | EASY-032 | Test raporu üret | P1 | 2 | EASY-028..031 | `docs/test-report.md` yayımlandı |
...
| [x] | EASY-040 | Container/çalıştırma reçetesi standardizasyonu | P0 | 5 | EASY-039 | `Dockerfile`, compose override'lari ve `scripts/deploy_compose.sh` ile tekrarlanabilir deploy adimlari tanimlandi |
...
| [x] | EASY-046 | Production release | P0 | 3 | EASY-045 | Sürüm canlıya alındı |
| [x] | EASY-047 | Post-release izleme ve hızlı düzeltme | P0 | 5 | EASY-046 | Kritik hata yok, varsa hotfix tamam |
| [x] | EASY-048 | Changelog ve kapanış raporu | P1 | 2 | EASY-046 | `CHANGELOG.md` + post-release raporu güncel |
